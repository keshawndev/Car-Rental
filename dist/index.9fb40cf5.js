...
function initMap() {
    ...
    document.querySelector(".locations__hover__box__flex__form__location-select").addEventListener("change", function() {
        const address = this.value;
        if (address !== "Please select a location") geocodeAddress(address);
    });
}
